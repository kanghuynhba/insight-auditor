...
# Rendered on retries — validations replaces the old misconceptions/omissions fields
# since AuditReport now stores the full FactValidation rows instead of separate lists
...
# Static example blocks slotted into the examples section — never contain real user data
